"""Unit tests for app/core/cloudflare_dns.py — `requests` itself is
...
def test_wait_for_propagation_returns_true_once_the_record_is_visible(monkeypatch: pytest.MonkeyPatch) -> None:
    responses = [
        _FakeResponse(200, {"result": []}),
        _FakeResponse(200, {"result": [{"content": "the-txt-value"}]}),
    ]
